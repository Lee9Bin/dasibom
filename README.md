...
- 관광 서비스 12개와 문화자원 5개의 수요 지표, 관련 지표를 묶은 6축 레이더 차트
- 관광지·음식점·숙박을 각각 최대 50곳까지 조회수 기준으로 큐레이션
- 수상작을 우선하되 장소별 대표 사진을 선별하는 갤러리와 추가 불러오기
...
2026-09-24 개선 사항과 후속 과제는 [`docs/quality-release-2026-09-24.md`](docs/quality-release-2026-09-24.md), 추가 API 신청 여부는 [`docs/api-access-2026-09-24.md`](docs/api-access-2026-09-24.md)에 정리했습니다.
