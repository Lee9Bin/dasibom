...
class TourApiClientTest {
    ...
    @Test void parsesPaginationMetadata()throws Exception{var page=TourApiClient.parsePage(mapper.readTree("{\"response\":{\"header\":{\"resultCode\":\"0000\"},\"body\":{\"totalCount\":57,\"pageNo\":2,\"numOfRows\":12,\"items\":{\"item\":[{\"id\":1}]}}}}"));assertThat(page.totalCount()).isEqualTo(57);assertThat(page.pageNo()).isEqualTo(2);assertThat(page.numOfRows()).isEqualTo(12);}
